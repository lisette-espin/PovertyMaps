...
def update_opencellid_features(fn_cells, fn_places, antenna_same_tower_max_distance=5.0):
  ### 1. load cell ids
  print(fn_cells)
  ...
  lat,lon = ('LATNUM', 'LONGNUM') if 'LATNUM' in df_places.columns else ('lat','lon')
  ...
  ### 4. Identify towers
  gdf_cells_proj = geo.fast_identify_clusters_within_distance(gdf_cells_proj, max_distance=antenna_same_tower_max_distance, n_jobs=10)
